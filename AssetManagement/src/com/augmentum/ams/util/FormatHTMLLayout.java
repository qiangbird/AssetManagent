...
public class FormatHTMLLayout extends HTMLLayout {   
    ...
    public String format(LoggingEvent event) {   
        ...
        if (locationInfo) {   
            ...
            sbuf.append("<td title=\"error\">"); 
            sbuf.append("<font color=\"red\">"); 
            sbuf.append(Transform.escapeTags(locInfo.getFileName()));  
            sbuf.append(':');  
            sbuf.append(locInfo.getMethodName()).append("():");
            sbuf.append(locInfo.getLineNumber()).append(" line has error"); 
            sbuf.append("</font>"); 
            sbuf.append("</td>" + Layout.LINE_SEP);  
        }  
        ...
        if (s != null) {   
            sbuf.append("<tr><td bgcolor=\"white\" style=\"color:black; font-size : xx-small;\" colspan=\"4\">");   
