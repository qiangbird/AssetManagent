...
public class RemoteCustomerServiceImpl implements RemoteCustomerService {
    ...
    public List<Customer> getCustomerCodesByEmployeeId(String employeeId,
        ...
        searchModel
                .setColumns(new String[] { IAPConstans.CUSTOMER_NAME, IAPConstans.CUSTOMER_CODE });
        searchModel.setFilter(SqlRestrictionsUtil.or(
                SqlRestrictionsUtil.eq(IAPConstans.MANAGER_EMPLOYEEID, employeeId),
                SqlRestrictionsUtil.eq(IAPConstans.DIRECTOR_EMPLOYEEID, employeeId)));
        ...
        for (Map<String, Object> mapData : responseData) {
            String customerCode = (String) mapData.get(IAPConstans.CUSTOMER_CODE);
            if (!customerCodes.contains(customerCode)) {
                String customerName = (String) mapData.get(IAPConstans.CUSTOMER_NAME);
