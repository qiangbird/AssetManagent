...
public class PropertyTemplateController extends BaseController{
    ...
    public ModelAndView getCustomerAndAssetType(HttpServletRequest httpServletRequest)
        ...
        List<Customer> customerInfo = remoteCustomerService
                .getCustomerCodesByEmployeeId(employeeId, httpServletRequest);
    ...
    public String saveSelfProperty(String selfProperties, String customerCode, String assetType) throws ParameterException, DataException {
        ...
        Customer dataBaseCustomer = customerService.getCustomer(propertyTemplateVo.getCustomerCode());
    ...
    public ModelAndView getPropertyTemplates(String customerCode, String assetType) throws ParseException {
        
        ModelAndView modelAndView = new ModelAndView();
        PropertyTemplateVo propertyTemplateVo = new PropertyTemplateVo(null,
                customerCode, assetType);
        ...
        JSONArray propertyTemplates = propertyTemplateService
                .findPropertyTemplateByCustomerAndAssetType(customer.getCustomerName(), propertyTemplateVo.getAssetType());
