...
public class SpecialRoleController extends BaseController{
	...
	public String saveOrUpdateSpecialRole(SpecialRoleVo specialRoleVo){
	    ...
	    logger.info(LogHelper.getLogInfo("Save or update specialRole at controller start", specialRoleVo.getSpecialRoles()));
	...
	@ResponseBody
	public JSONArray findEmployeesByCustomerCode(SpecialRoleVo specialRolevo, HttpServletRequest httpServletRequest){
