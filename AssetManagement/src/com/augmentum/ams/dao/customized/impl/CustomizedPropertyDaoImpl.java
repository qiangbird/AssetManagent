...
public class CustomizedPropertyDaoImpl extends BaseDaoImpl<CustomizedProperty> implements CustomizedPropertyDao{
	...
	public CustomizedProperty getCustomizedPropertyByTemplateId(String templateId) {
		String hql="from CustomizedProperty where propertyTemplate.id = ?";
		return super.getUnique(hql, templateId);
	}
