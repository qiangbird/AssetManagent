...
public class SpecialRoleDaoImpl extends BaseDaoImpl<SpecialRole> implements SpecialRoleDao{
	...
	/* (non-Javadoc)
	 * @see com.augmentum.ams.dao.user.SpecialRoleDao#getSpecialRoleByUserId(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.augmentum.ams.dao.user.SpecialRoleDao#getSpecialRoles(java.util.List)
	 */
	@Override
	public List<SpecialRole> findSpecialRolesByCustomerCodes(List<String> customerCodes) {
	    logger.info(LogHelper.getLogInfo("Get special role by user id start, customerCodes size", customerCodes.size()));
        ...
        logger.info(LogHelper.getLogInfo("Get special role by user id end, specialRoles size", specialRoles.size()));
