(function($,window){
    ...
    $.DropDownList = function(ele, opts){
        var $self = this;
        var opts = (this.opts = $.extend({},$.fn.DropDownList.def,opts));
    ...
    $.DropDownList.prototype = {
        ...
        _updateHeader : function(){
            var o = this.opts,
             ...
             if(!numChecked){
				...
				(typeof numChecked === 'string' || ((typeof numChecked === 'object') && numChecked.length <= o.selectedList))){
        ...
        refresh : function(){
            var o = this.opts,
                ...
                html = [],
                $self = this;
            $self.options = this.ele.find('option');
