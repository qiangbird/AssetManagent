...
<body>
	...
	<input id="categoryType" type="hidden" value="operation log">
	<input id="currentPage" type="hidden" value="operationLogPage">
	<div id="blank">
...
<script type="text/javascript" src="js/operationLog/searchOperationLogList.js" ></script>
