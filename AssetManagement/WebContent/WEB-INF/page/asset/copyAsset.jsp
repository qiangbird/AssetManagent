...
<body>
    ...
    <div id="main">
        <div class="home">
            ...
            <a href="#"><label id="label_Home"></a>
            </span>
            <span class="catelog-in-line">></span> 
            <span class="breadCrum"><label id="label_CopyAsset"></span>
        </div>
        <div id="createAssetContent">
            ...
            <form:form action="asset/saveNewAsset" method="post" id="assetFrom"
                ...
                <div class="common-requirement-property">
                    <div class="asset-input-left asset-input-panel">
                        ...
                        <p>
                            ...
                            <%-- <form:input path="status" id="selectedStatus" cssClass="l-select" readonly="true"/> --%>
                        </p>
                        <p>
                    ...
                    <div class="common-asset-input-right asset-input-panel">
                        ...
                        <p class="p-textarea">
                            <label><label id="label_AssetMemo"></label></label> <span
                ...
                <div class="showAsSelect">
                            ...
                            <div class="asset-input-left asset-input-panel">
                                <p>
                                    <span>*</span> <label><label
                                        id="label_AssetMachineSubtype"></label></label>
                    ...
                    <div id="monitorDetails" class="type-details" style="display: none">
                        ...
                        <div class="asset-input-right asset-input-panel">
                            <p class="p-textarea">
                                <label><label id="label_AssetMonitrDetails"></label></label> <span
                    ...
                    <div id="softwareDetails" class="type-details"
                        ...
                        <div class="asset-input-right asset-input-panel">
                            <p>
                                <span>*</span> <label><label
                                    id="label_AssetSoftwareMaxUserNum"></label></label>
                ...
                <div class="asset-batch-create">
                    <span id="batchCreatCkBox"> <input type="checkbox"
                        id="batchCreate" name="batchCreate"></span> <label
                        class="bath-create-asset"><batch id="label_BatchCreate"></batch></label>
                    <label class="form-control l-text"> <input id="showBatch"
                        type="text" name="batchCount" class="showBatchNormal" value="1"
                        required></label>
                </div>
                ...
                <div class="operation">
                    <div class="operation_location">
                        <input type="button" value="Submit" class="submit-button"
                            id="submitForm" /> <input type="button" value="Cancel"
