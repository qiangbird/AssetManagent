...
<div id="main">
   <div class="home">
        ...
        <span class="breadCrum"><label id="label_CreateAsset"></span>
    </div>
    ...
    <form:form action="asset/saveNewAsset" method="post" id="assetFrom" modelAttribute="assetVo">
    ...
    <div class="asset-input-left asset-input-panel">
       ...
       <p>
        ...
        <span>*</span> <label><label id="label_AssetOwnerShip"></label></label>
            ...
            cssClass="l-select" cssErrorClass="l-select-error" placeholder="Please select OwnerShip" />
        </p>
        <p>
            <span>*</span> <label><label id="label_AssetUsedBy"></label></label>
            <form:input path="customer.customerName" id="customerName" maxlength="36"
            cssClass="l-select" cssErrorClass="l-select-error" placeholder="Please select Custumer" />
         ...
         <p>
			...
			<form:input path="project.projectName" id="project" class="l-select" 
			readonly="readonly" placeholder="Please select Project" />
        ...
        <p>
            <span>*</span> <label><label id="label_AssetStatus"></label></label>
                <form:select path="status" cssClass="l-select" id="selectedStatus" >
...
<img src="${assetVo.photoPath }" id="aphoto" />
   ...
   <p>
      ...
      <p>
       ...
       <p class="p-textarea">
           ...
           <form:textarea path="memo" cssClass="l-textarea" />
               </span>
           </p>
       </div>
   </div>
  ...
  <div class="showAsSelect">
                    ...
                    <form:hidden path="machine.id"/>
                        <div class="asset-input-left asset-input-panel">
                            <p>
                                ...
                                <form:select path="machine.subtype" id="machineType" items="${machineTypes}"></form:select>
                            </p>
                            <p class="p-textarea">
   ...
   <div class="asset-batch-create">
       ...
       <input type="checkbox" id="batchCreate" name="batchCreate"></span>
       <label class="bath-create-asset"><batch id="label_BatchCreate"></batch></label>
       <label class="form-control l-text">
       <input id="showBatch" type="text" name="batchCount" class="showBatchNormal" value="1" required></label>
   </div>
