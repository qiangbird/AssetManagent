   ...
   <div class="home">
    ...
    <div class="asset-input-left asset-input-panel">
        ...
        <p>
           ...
           <%--  <form:input path="type" id="assetType" maxlength="36"
                cssClass="l-select" placeholder="Please select a asset type"
                readonly="true" /> --%>
                 <form:input path="type" id="assetType" readonly="true" />
                
        </p>
       <%--  <div class="showAssetTypes">
            <c:forEach var="assetTypeItems" items="${assetType}">
                <li class="showAssetTypesItems"><c:out
                        value="${assetTypeItems}"></c:out></li>
            </c:forEach>
        </div> --%>
        <p>
        ...
        <form:input path="ownerShip" id="ownership" maxlength="36"
            cssClass="l-select" readonly="true"
            placeholder="Please select Ownership" />
        </p>
        <div class="showOwnership" onblur="hideSelect()">
        <li class="showOwnershipItems">Augmentum</li>
        <li class="showOwnershipItems">Charge to customer</li>
        <li class="showOwnershipItems">Shipped by customer</li>
        </div>
        <p>
        ...
        <p>
            ...
            <form:input path="status" id="selectedStatus" maxlength="36"
                cssClass="l-select" readonly="true"
                placeholder="Please select Status" />
        </p>
        <div class="showAssetStatus" onblur="hideSelect()">
            <c:forEach var="assetStatusItems" items="${assetStatus}">
                <li class="showAssetStatusItems">
                ${assetStatusItems}
                </li>
            </c:forEach>
        </div>
       ...
       <p>
         ...
         <p>
             <label><label id="label_Keeper"></label></label>
              <%-- <form:input path="keeper.keeperName" id="keeperSelect"  class="l-text" readonly="readonly"/>
              <form:hidden path="keeper.keeperCode" id="keeperCode"/> --%>
  ...
  <div class="common-asset-input-right asset-input-panel">
   <p>
       ...
       <p>
           ...
           <form:input path="entity" id="selectedEntity"
               cssClass="l-select" readonly="true"
               placeholder="Please select an Entity" />
       </p>
       <div class="showEntity" onblur="hideSelect()">
           <c:forEach var="allEntityItems" items="${allEntity}">
               <li class="showEntityItems"><tr>${allEntityItems}</tr></li>
           </c:forEach>
       </div>
   
      <p>
            <span>*</span> <label><label id="label_AssetLocation"></label></label>
            <form:input path="location" id="selectedLocation" maxlength="36" cssClass="l-select"
             readonly="true" placeholder="Please select Location"/>
        </p>
        <div class="showLocation" onblur="hideSelect()">
            <c:forEach var="siteListItems" items="${siteList}">
                <li class="showLocationItems">
                <c:out value="${siteListItems.site}${siteListItems.room}"></c:out>
                </li>
            </c:forEach>
        </div>
        <p>
            <span>*</span><label><label id="label_AssetUser"></label></label>
            <form:input path="user.userName" id="assertUser" maxlength="36"
